...
motor lowerIntake = motor(PORT10, ratio6_1, false);
motor upperIntake = motor(PORT20, ratio6_1, true);
motor_group intake_motor = motor_group(lowerIntake, upperIntake);
...
double distance_between_wheels = 10.875;
...
double front_sensor_offset = 5.75;
double left_sensor_offset = 5.375;
double right_sensor_offset = 5.375;
double back_sensor_offset = 3.875;
